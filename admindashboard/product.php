                  ...
                  ?>    
                    <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td>
                        ...
                        if($select_product_category->rowCount() > 0 ){
                          while($fetch_product_category = $select_product_category->fetch(PDO::FETCH_ASSOC)){
                            if( $fetch_products['category_id'] == $fetch_product_category['category_id'] )
                            { echo 
                             $fetch_product_category['name'];
                            }
                      ...
                      <td>
                        <button class="btn btn-success mt-2"><a href="updateproduct.php?update= $fetch_products['product_id']; ?>" class="text- 
                        light">Update</a></button>
                        <button class="btn btn-danger mt-2"><a href="deleteproduct.php?delete= $fetch_products['product_id']; ?>" class="text- 
